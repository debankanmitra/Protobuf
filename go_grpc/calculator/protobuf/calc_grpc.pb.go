...
const (
	CalcService_Calculate_FullMethodName = "/calculator.CalcService/Calculate"
)
...
func (c *calcServiceClient) Calculate(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, CalcService_Calculate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCalcServiceServer) Calculate(context.Context, *SumRequest) (*SumResponse, error) {
...
func _CalcService_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalcServiceServer).Calculate(ctx, req.(*SumRequest))
	}
